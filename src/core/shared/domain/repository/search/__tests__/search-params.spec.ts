...
describe('SearchParams Unit Tests', () => {
  ...
  test('per_page prop', () => {
    ...
    const arrange = [
      { per_page: null, expected: 5 },
      { per_page: undefined, expected: 5 },
      { per_page: '', expected: 5 },
      { per_page: 'fake', expected: 5 },
      { per_page: 0, expected: 5 },
      { per_page: -1, expected: 5 },
      { per_page: 5.5, expected: 5 },
      { per_page: true, expected: 5 },
      { per_page: false, expected: 5 },
      { per_page: {}, expected: 5 },
